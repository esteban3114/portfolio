...
const SECTIONS = {
  ...
  STACK: {
    ...
    lines: () => {
      ...
      return [
        ...
        r("33", "SvelteKit", "Framework", 7, "SOLID"),
        r("34", "Supabase", "Backend", 7, "SOLID"),
        r("35", "Git", "Versioning", 8, "HIGH"),
        r("36", "pytest", "Testing", 7, "SOLID"),
        r("37", "ruff", "Linting", 7, "SOLID"),
        r("38", "mypy", "Type-check", 6, "SOLID"),
        r("39", "Vercel", "Cloud / Ops", 7, "SOLID"),
        blank(),
  ...
  CONTACT: {
    ...
    lines: () => [
      ...
      [seg("43) ", "num"), seg(pad("LINKEDIN", 20), "label"), { t: PROFILE.linkedin, c: "blueval", href: "https://" + PROFILE.linkedin, target: "_blank" }],
      [seg("44) ", "num"), seg(pad("INSTAGRAM", 20), "label"), { t: "instagram.com/" + PROFILE.instagram, c: "blueval", href: "https://instagram.com/" + PROFILE.instagram, target: "_blank" }],
      blank(),
      head("STATUS"),
      row("45", "AVAILABILITY", "Open to collaboration", "pos"),
      row("46", "RESPONSE TIME", "< 24h", "val"),
      blank(),
...
const BOOT_LINES = [
  ...
  { t: "Loading este-dls.com............ OK", c: "boot-ok" },
